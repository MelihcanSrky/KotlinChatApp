package com.kotlin.chatapp.presentation.features.auth.components
...
fun CATextField(
    ...
    OutlinedTextField(
        ...
        singleLine = true,
        textStyle = ChatAppTypo.bodyMedium.copy(color = MaterialTheme.colorScheme.surface),
        label = {
            Text(text = label, style = ChatAppTypo.bodySmall.copy(fontSize = 12.sp))
        },
